    ...
    <div class="logoAndBar">
        ...
        <div class="desktopBars">
            <ul>
                ...
                <li class="hideOnMobile"><a href="#">Parts</a></li>
            </ul>
        </div>
...
<div class="apt">
<h2>Error 503</h2>
<i class="fa-solid fa-road-circle-xmark constr" ></i>
<h3>We're still paving the road for this page</h3>
</div>